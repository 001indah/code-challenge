...
const Card: React.FC<CardProps> = ({ user, jobDescription }) => {
    return (
        <div role="listitem" className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div className="rounded-xl overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                    ...
                    <p className="text-gray-800 text-xs lg:text-sm text-center">{jobDescription.role}</p>
                    <p className="text-center text-gray-600 text-xs lg:text-base pt-3 font-normal">{jobDescription.description}</p>
