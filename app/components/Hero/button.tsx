...
const Button: React.FC<ButtonProps> = ({ children, className, href }) => {
    return (
        <div>
            <a href={href} className={`ease-in-out duration-200 group flex  cursor-pointer items-center justify-center rounded-md bg-black px-6 py-2 text-white transition mb-3 ${className}`}>
