...
import smile from '@/public/smile.webp'
                    ...
                    <div className="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-3/5">
                        ...
                        <form>
                            <div className="relative mt-2 w-full">
                                <input type="text" id="email" aria-label='email' className="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                            ...
                            <div className="relative mt-2 w-full">
                                <input type="text" id="text" aria-label='message' className="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
